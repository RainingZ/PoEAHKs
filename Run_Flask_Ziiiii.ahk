...
send, /kick Ziiiiiiiiiiiiiiiiiiiii
send, {Enter}
return
...
if (Run) {
	;send, a ; Comment this to disable righteous fire before auto-run
	send, {LButton down}
} else {
	send, {LButton up}
}
...
SetTimer, Loop2, % (Toggle) ? 4800 : "Off"
SetTimer, Loop3, % (Toggle) ? 4200 : "Off"
SetTimer, Loop4, % (Toggle) ? 6100 : "Off"
